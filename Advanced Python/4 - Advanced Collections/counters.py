...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 10 15:52:11  2022
...
def main():
    ...
    class1 = ['Bob', 'Becky', 'Chad', 'Darcy', 'Frank',
              'Hannah', 'Kevin', 'James', 'James', 'Melanie',
              'Penny', 'Steve']
    
    # list of students in clsas 2
    class2 = ['Bill', 'Barry', 'Cindy', 'Debbie', 'Frank',
              'Gabby', 'Kelly', 'James', 'Joe', 'Sam',
              'Tara', 'Ziggy']
    ...
    # TODO: How many students in class 1 names James?
    # print(c1['James'])
